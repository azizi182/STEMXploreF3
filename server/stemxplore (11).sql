...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2026 at 01:23 PM
...
(1, 1, 'Biologist', 'Study living organisms', 'Kaji organisma hidup', '', 'Ahli biologi'),
(2, 2, 'Software Developer', 'Create applications and systems', 'Cipta aplikasi dan sistem', '', 'Pembangun Perisian'),
(3, 3, 'Civil Engineer', 'Design buildings and infrastructure', 'Reka bentuk bangunan dan infrastruktur', '', 'Jurutera Awam'),
(4, 4, 'Data Scientist', 'Analyze data using mathematics', 'Menganalisis data menggunakan matematik', '', 'Saintis Data'),
(5, 1, 'Chemist', 'works with chemicals in laboratories, pharmaceuticals, or manufacturing.', 'bekerja dengan bahan kimia di makmal, farmaseutikal atau pembuatan.', '', 'Ahli kimia'),
(6, 1, 'Microbiologist', 'studies microorganisms like bacteria and viruses.', 'mengkaji mikroorganisma seperti bakteria dan virus.', '', 'Ahli mikrobiologi'),
(7, 1, 'Food Scientist', 'develops and improves food safety and food production.', 'membangun dan menambah baik keselamatan makanan dan pengeluaran makanan.', '', 'Saintis Makanan'),
(8, 2, 'Web Developer', 'develops websites using HTML, CSS, PHP, JavaScript.', 'membangunkan laman web menggunakan HTML, CSS, PHP, JavaScript.', '', 'Pembangun Web'),
(9, 2, 'Cybersecurity Analyst', 'protects systems from hackers and cyber threats.', 'melindungi sistem daripada penggodam dan ancaman siber.', '', 'Penganalisis Keselamatan Siber'),
(10, 2, 'AI / Machine Learning Engineer', 'develops artificial intelligence systems.', 'membangunkan sistem kecerdasan buatan.', '', 'Jurutera AI / Pembelajaran Mesin'),
(11, 3, 'Mechanical Engineer', 'designs machines, engines, and mechanical systems', 'mereka bentuk mesin, enjin dan sistem mekanikal', '', 'Jurutera Mekanikal'),
(12, 3, 'Aerospace Engineer', 'designs aircraft and space technologies', 'mereka bentuk teknologi pesawat dan angkasa lepas', '', 'Jurutera Aeroangkasa'),
(13, 3, 'Electrical Engineer\r\n', 'works with electrical systems, power grids, and electronics', 'berfungsi dengan sistem elektrik, grid kuasa dan elektronik', '', 'Jurutera Elektrik'),
...
(10, 4, 'Reactivity of Metals', 'Kereaktifan Logam', '', '', 1, 'no'),
